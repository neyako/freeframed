...
| 022 | Offer "upload as new version" when a dropped/selected file matches an existing asset | FreeFrame `apps/web` | P2 | M | — | DONE ✓ verified 07-01 — committed on branch; required `.gitignore` `/lib/` anchor (Python template ate `apps/web/lib/`) |
