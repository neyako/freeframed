...
| 024 | Hide comments panel until an asset is selected + collapsible assets panel | FreeFrame `apps/web` | P2 | S–M | — | DONE ✓ verified 2026-07-01 — right panel gated on selectedAsset; left panel collapsible with slim rail |
