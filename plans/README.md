...
| 026 | Restore green web test/type baseline (stale vitest mocks + asset-grid fixture + Node-25 localStorage) | FreeFrame `apps/web` | P1 | S–M | — | DONE ✓ verified 2026-07-01 (branch `advisor/026-web-test-baseline`) |
